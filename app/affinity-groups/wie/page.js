          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 mb-8">
              ...
              <div className="flex justify-center">
                <button className="inline-flex items-center gap-2 bg-blue-600 text-white px-8 py-3 rounded-full hover:bg-blue-700 transition-colors duration-300 shadow-lg hover:shadow-xl">
